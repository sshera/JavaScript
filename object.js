...
let contacts = {
    customers: [ 
        ...
        { firstName: 'Richard', lastName: 'Boughton', phoneNumbers: [ '(123) 678-9012', '(123) 789-0123' ] }
    ],
    employees: [
        { firstName: 'Steve', lastName: 'Jaworski', phoneNumbers: [ '(312) 456-7890', '(312) 567-8901' ] },
        { firstName: 'Conrad', lastName: 'Tabor', phoneNumbers: [ '(312) 678-9012' ] },
        { firstName: 'Grant', lastName: 'Tabor', phoneNumbers: [ '(312) 789-0123' ] }
    ]
};